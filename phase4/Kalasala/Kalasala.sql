...
CREATE TABLE `Doctor_1` (
  ...
  KEY `Doctor_ID` (`Doctor_ID`),
  CONSTRAINT `Doctor_1_ibfk_1` FOREIGN KEY (`Doctor_ID`) REFERENCES `Patient_1` (`Doctor_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Doctor_2` (
  ...
  KEY `Doctor_ID` (`Doctor_ID`),
  CONSTRAINT `Doctor_2_ibfk_1` FOREIGN KEY (`Doctor_ID`) REFERENCES `Patient_1` (`Doctor_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Doctor_3` (
  ...
  KEY `Doctor_ID` (`Doctor_ID`),
  CONSTRAINT `Doctor_3_ibfk_1` FOREIGN KEY (`Doctor_ID`) REFERENCES `Patient_1` (`Doctor_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Rooms` (
  ...
  CONSTRAINT `Rooms_ibfk_1` FOREIGN KEY (`Room_ID`) REFERENCES `Patient_1` (`Room_ID`),
  CONSTRAINT `Rooms_ibfk_2` FOREIGN KEY (`Room_ID`) REFERENCES `Nurse_1` (`Room_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-11-12 14:31:30
